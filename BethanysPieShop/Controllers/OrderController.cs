    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Checkout(Order order)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                mail.From = new MailAddress("eerzho@mail.com", "BethanysPieShop", System.Text.Encoding.UTF8);
                ...
                client.Credentials = new System.Net.NetworkCredential("eerzho@gmail.com", "zhanbodler1999");
                client.Port = 587;
